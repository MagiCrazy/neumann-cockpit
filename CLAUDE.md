...
- **Phase 4 (todo)** — probe models in the assembly wizard (per-model bill; the tanker adds 10 steel plates, 2 linear actuators, 1 integrated circuit and carries a 400-point tank), the fleet roster and `:tree`.
