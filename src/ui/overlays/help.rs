...
const LEFT: &[Section] = &[
    ...
    (
        ...
        &[
            ...
            ("s", "Hold: sort containers a-z / probe order"),
            ("h l", "Scanner: detail ⇄ history column"),
...
const RIGHT: &[Section] = &[
    (
        ...
        &[
            ...
            ("Hold", "fabricate, jettison, move stock;"),
            ("", "on a container: rename, rules,"),
            ("", "move craft reservations out"),
            ("Missions", "browse steps, abandon"),
            ("Logbook", "c write · e edit · x delete"),
            ("", "Ctrl-S saves a page"),
            ("Log", "read-only ship's journal (its own pane)"),
    ...
    (
        ...
        &[
            ...
            ("prefix", "enough letters to be unambiguous runs it"),
